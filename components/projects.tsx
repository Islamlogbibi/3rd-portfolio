...
const projects: Project[] = [
  ...
  },
  {
    ...
    badges: ['Deployed in Annaba central hospital'],
    filter: ['Web'],
  ...
  },
  {
    ...
    tech: ['Flutter', 'GOLANG', 'PostgreSQL', 'Redis'],
    features: [
      'QR code payments',
  ...
  },
  {
    ...
    tech: ['Python', 'RAG', 'data analysis', 'Predictive Analytics'],
    features: [
      'AI-powered ecological analysis',
      'Chatbot for tourist guidance',
  ...
  },
  {
    ...
    type: 'Mobile App',
    solution: 'mobile app for restaurant order and inventory management.',
  ...
  },
  {
    ...
    features: [
      ...
      'Real-time sensor fusion (camera, ultrasonic, microphone)',
      'Intelligent task execution logic',
      'Real-time ask and answer system through microphone and speaker',
